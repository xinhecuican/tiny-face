...
import numpy as np
import cv2
os.add_dll_directory('C:\\Users\\HP\\AppData\\Roaming\\Python\\Python38\\site-packages\\mxnet')
import mxnet as mx
import argparse, time
from mxnet_face.detection.symbol.resnet import *
from mxnet_face.detection.symbol.config import config
from mxnet_face.detection.symbol.processing import bbox_pred, clip_boxes, nms
